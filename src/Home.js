    ...
    return (
        <div className="dev">
            <Container className="top pt-5 pb-5 ">
                <Row>
                    <Col >
                        <h1 className="cn mt-5 pt-5">Hello, I'm<span className="id"> Stanley</span></h1>
                        <p className="hc mt-5"><span className="idd">Front end developer</span> seeking an entry-level front end developer role to be a valuable asset to the company.</p>
                    ...
                    <Col className="pt-5 mt-5 "></Col> <span className="mt-3 pt-5 ">
                ...
                <Container>
                    <p className="text-center mt-5 mb-0 pt-5 projecthead"> My projects</p>
                </Container>
                <Row>
                    <h1 className="mt-5 heading">Shopping Cart</h1>
                    <Col lg="7" className="" >
                    ...
                    <Col className="m-auto"><img src={eimage} className="w-100 "></img></Col>
                </Row>
                <Row>
                    <h1 className="mt-5 heading">Cinescope</h1>
                    <Col lg="7">
                        <p className="project1 mt-3">
                    ...
                    <Col className="m-auto"><img src={movie} className="w-100 "></img></Col>
                </Row>
                <Row>
                    <h1 className="mt-5 heading">CRUD App</h1>
                    <Col lg="7">
                    ...
                    <Col className="m-auto"><img src={crud} className="w-100 "></img></Col>
                </Row>
                <Row>
                <h1 className="mt-5 heading">API fetch</h1>
                <Col lg="7">
               ...
               <Link to={"https://github.com/Stanleyms/API-fetch"}> <Button className="sm">View</Button></Link>
                ...
                <Col className="m-auto"><img src={api} className="w-100 "></img></Col>
                </Row>
                <Row>
                <h1 className="mt-5 heading">Form validation</h1>
                <Col lg="7">
                ...
                <Col className="m-auto"><img src={form} className="w-100 "></img></Col>
                </Row>
            </Container>
